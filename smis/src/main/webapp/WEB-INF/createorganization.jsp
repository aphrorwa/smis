...
<div id="middle">
	...
	<div class="search">
		<form action="organization.ap?page=search?" method="get">
			<table>
				<tr>
					<td style="color: #004216;">Departments</td>
...
<div id="tabs-wrapper" class="clear-block">
	<ul class="tabs primary">
		<li class=""><a
			href="listorganization.ap?page=organizations&&action=list">Department</a></li>
		<li class="active"><a
			href="createorganization.ap?page=createorganization"><img
				src="icons/add.png" /> New Department</a></li>
		...
		<form action="createorganization.ap?page=createorganization"
			...
			<fieldset>
				...
				<table style="border: 0;">
					...
					<tr>
						<td align="right"><b>Parent Department</b></td>
