		...
		<div id="middle">
			<c:if test="${authenticatedUser !=null}">
				<div class="options">
					...
					<a href="CreateUserServlet?page=createuser"><button>
							<img src="icons/user_add.png" /> New User Registration
						</button></a>
				</div>
				<div class="search">
					<form action="listuser.ap" method="get">
						<table>
							<tr>
				...
				<hr />
				<form action="listuser.ap?page=statusapproval" method="post">
					<fieldset>
							...
							<tbody>
								<c:forEach items="${users}" var="usr" varStatus="usrstatus">
									<tr>
										...
										<td>${usr.status.getApprovalStatusDescription()}</td>
