...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript" src="js/Waziup.js" />
	<link rel="stylesheet"
		href="https://unpkg.com/leaflet@1.3.1/dist/leaflet.css" />
	<script src="https://unpkg.com/leaflet@1.3.1/dist/leaflet.js"></script>
	<script type="text/javascript" src="js/WaziupMap.js"></script>

	<title>${param.title}</title> <!-- CALENDER CODES -->
	...
	<script language="javascript">
		...
		function autoTab(startPoint, endPoint) {
			if (startPoint.getAttribute
					&& startPoint.value.length == startPoint
...
<body>
	<div id="layout">
		<div id="banner">
			...
			<div class="text_header">Home Monitoring and Notification
				System</div>
